...
import com.teamsun.mapred.DqcMapper_deli_utf8;
import com.teamsun.metadata.TableService;
/**
 * @author wpf
 *
 */
public class DataQualityCheck_deli_utf8 {
	...
	public static void main(String[] args) {
		...
		titleFileName=FileUtil.getTitleFileName(conf, new Path(inputPath));
			...
			status = new DataQualityCheck_deli_utf8().run(col_Size,seq,data_length,primarykey_order_id,conf);
	...
	private int run(long cols,String seq,String data_length,String primarykey_order_id,Configuration conf) throws IOException, ClassNotFoundException, InterruptedException{
		...
		job.setJarByClass(DataQualityCheck_deli_utf8.class);
		job.setMapperClass(DqcMapper_deli_utf8.class);
