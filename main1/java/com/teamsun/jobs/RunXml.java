...
import com.teamsun.mapred.DqcMapper_RunXml;
...
public class RunXml {
	...
	private static final Logger Log = LoggerFactory.getLogger(RunXml.class);
...
//		conf.set("mapred.job.queue.name", "bpsctb");
		...
		job.setJarByClass(RunXml.class);
		job.setMapperClass(DqcMapper_RunXml.class);
