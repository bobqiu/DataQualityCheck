 ...
 * 
 */
public class DqcMapperlj extends Mapper<LongWritable, Text, Text, Text> {


	private static final Logger Log = LoggerFactory.getLogger(DqcMapperlj.class);
...
//		return new String[0];
	...
	public static void main1(String[] args) {
		String str = "a|+|b+|c";
		String[] items = new DqcMapperlj().replaceRF(str).split(Constants.HIVE_RF, 3);
		if (3 != items.length) {
			items=new DqcMapperlj().repairSeparator(new DqcMapperlj().replaceRF(str));
		}
		for(String a :items){
